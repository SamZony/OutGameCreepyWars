...
Shader "Toby Fredson/The Toby Foliage Engine/(TTFE) Tree Bark (Nature Renderer)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord18_g227 = packedInput.ase_texcoord5.xy * _Tiling + _Offset;
				
				float3 unpack7_g227 = UnpackNormalScale( tex2D( _NormalMap, texCoord18_g227 ), _NormalIntensity );
				unpack7_g227.z = lerp( 1, unpack7_g227.z, saturate(_NormalIntensity) );
				
				float4 tex2DNode11_g227 = tex2D( _MaskMap, texCoord18_g227 );
				
				surfaceDescription.BaseColor = tex2D( _AlbedoMap, texCoord18_g227 ).rgb;
				surfaceDescription.Normal = unpack7_g227;
				...
				surfaceDescription.Smoothness = ( tex2DNode11_g227.a * _Smoothnessintensity );
				surfaceDescription.Occlusion = pow( abs( tex2DNode11_g227.g ) , _Aointensity );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord18_g227 = packedInput.ase_texcoord2.xy * _Tiling + _Offset;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord18_g227 = packedInput.ase_texcoord3.xy * _Tiling + _Offset;
				float3 unpack7_g227 = UnpackNormalScale( tex2D( _NormalMap, texCoord18_g227 ), _NormalIntensity );
				unpack7_g227.z = lerp( 1, unpack7_g227.z, saturate(_NormalIntensity) );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord18_g227 = packedInput.ase_texcoord7.xy * _Tiling + _Offset;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;2693;-240,48;Inherit;False;(TTFE) Tree Bark_Shading;0;;227;07105d68e42fa94479944563340e838c;0;0;4;COLOR;0;FLOAT3;12;FLOAT;13;FLOAT;14
...
ASEEND*/
//CHKSM=05F2393268FB1105070ED858CBF7FE8C34F28D6A